...
import Suite2 from "../assets/images/suite_2.webp"; 
import Suite3 from "../assets/images/suite_3.webp"; 
import Suite4 from "../assets/images/suite_4.webp"; 
import Suite5 from "../assets/images/suite_5.webp"; 
import Suite7 from "../assets/images/suite_7.webp"; 
import Suite8 from "../assets/images/suite_8.webp"; 
import Suite6 from "../assets/images/suite_6.webp"; 
import Suite9 from "../assets/images/suite_9.webp"; 
import Suite10 from "../assets/images/suite_10.webp"; 
import Suite11 from "../assets/images/suite_11.webp"; 
import Suite12 from "../assets/images/suite_12.webp"; 
import Suite13 from "../assets/images/suite_13.webp";
import Suite14 from "../assets/images/suite_14.webp"; 
import Suite15 from "../assets/images/suite_15.webp"; 
import Suite16 from "../assets/images/suite_16.webp"; 
import Suite17 from "../assets/images/suite_17.webp";

import React, { useState, useEffect } from 'react';
import { X, ChevronLeft, ChevronRight, BedDouble, Users, Circle} from 'lucide-react';
...
const VillaCardSimple = ({ villa, onOpenModal }) => {
  ...
  return (
    ...
    >
      <div className="h-45 md:h-64 overflow-hidden relative">
        <img 
      ...
      <div className="px-6 py-6">
        <h3 className="text-[18px] md:text-[24px] mb-4 md:mb-6 text-[#4a4a4a] tracking-[.07em] font-bold font-raleway truncate hover:text-[#518181]">
          {villa.title}
        </h3>
        {/* Display bed information with BedDouble icon */}
        <p className="flex items-center text-[14px] md:text-[16px] my-2 text-[#4a4a4a] tracking-[.07em] font-bold font-raleway">
          <BedDouble size={16} className="mr-2 font-bold text-[#4a4a4a]" />
          {bedText}
        </p>
        {/* Display maximum adults with Users icon */}
        <p className="flex mb-10 items-center text-[14px] md:text-[16px] my-2 text-[#4a4a4a] uppercase tracking-[.07em] font-bold font-raleway">
          <Users size={16} className="mr-2 font-bold text-[#4a4a4a]" />
          Max {villa.maxAdults} adults
        </p>
        {/* Display one highlight with its icon (or Circle as fallback) */}
        <p className="text-[13px] md:text-[14px]  text-[#2A3B3B] tracking-[.07em] font-extrabold font-raleway hover:underline"  onClick={() => onOpenModal(villa)}>See Room Details</p>
      </div>
    </div>
  );
};
      ...
      <div className="flex flex-col md:flex-row h-full overflow-hidden font-raleway">
        ...
        <div className="w-full md:w-1/2 p-6 overflow-y-auto order-2 md:order-1">
          ...
          <div className="flex items-center space-x-4 text-[15px]">
            <Link to="/booking" className="px-10 py-2 text-white bg-[#518181] transition relative overflow-hidden group">
...
const VillaGallery = () => {
  ...
  const villaData = [
    {
      title: "Executive Double Room With Beach View",
      size: "2 Single bed or 1 Queen bed", 
      sqft: 710,
      maxAdults: 3,
      features: [
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 mb-10 md:mb-0 md:py-20">
