...
import VillaGallery from "../components/diningCard.jsx";
...
function Dining () {
  return (
    <>
      <Navbar />
      <div className="flex flex-col md:flex-row items-left md:items-start gap-10 md:gap-50 max-w-4xl mx-auto mt-[200px] md:mt-[280px] px-8 md:px-0">
      {/* Left Heading */}
      <div className="md:w-1/3 text-left">
        ...
        <div className="group">
          <h2 className="text-[40px] md:text-[50px] text-[#2A3B3B] font-thin leading-[1.2em] tracking-[.03em] uppercase font-raleway">dining</h2>
      ...
      <div className="md:w-2/3">
        <h3 className="text-[20px] md:text-[25px] text-[#2A3B3B] font-thin leading-[1.2em] tracking-[.03em]  mb-5 font-raleway">Luxurious Dining in Del Hamor</h3>
